        ...
        <div className="">
          <div className="">
            <p className=" flex justify-center text-white text-xl pt-2  text-center">
              Next Gen Effortless Onboarding provides seamless <br />
          ...
          <div className=" flex justify-center space-x-6 pt-6">
            <div className="flex items-center hover:scale-95 ease-in-out duration-150">
              <a
                href="https://github.com/Thirumurugan7/EthMumbai"
                target="_blank"
                className="py-3 px-3 w-24 border-2 gradient-border flex justify-center cursor-pointer font-semibold text-white hover:bg-gradient-to-r from-emerald-500 via-violet-600 to-emerald-500 hover:text-black"
              >
                Github 🡥
              </a>
            </div>
            <div className="flex items-center hover:scale-95 ease-in-out duration-150">
              <a
                href="https://github.com/Thirumurugan7/EthMumbai"
                target="_blank"
                className="py-3 px-3 w-24 border-2 flex justify-center gradient-border cursor-pointer font-semibold text-white hover:bg-gradient-to-r from-emerald-500 via-violet-600 to-emerald-500 hover:text-black"
              >
                Docs 🡥
              </a>
            </div>
